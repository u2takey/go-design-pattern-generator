...
public class FactoryTemplate extends DesignPattern {
     ...
     * 要实现工厂模式的结构体
     */
    private List<GoTypeSpec> lists;
    /**
     * 工厂模式返回的接口
     */
    private GoTypeSpec interfaceToImpl;

    public FactoryTemplate(@NotNull AnActionEvent event, List<GoTypeSpec> lists,
    ...
    private void createFactoryStruct(GoTemplate template) {
        ...
        builder.append(String.format(format,
                StringUtil.decapitalize(interfaceName), interfaceName, interfaceName,
                interfaceToImpl.getName()
        ));
