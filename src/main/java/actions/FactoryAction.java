...
public class FactoryAction extends BaseAction {
    ...
    protected void actionPerformedImpl(AnActionEvent event, Project project, GoFile file,
        ...
        PopupUtil.getMultiChooseStructPopup(file, editor, project, null, list -> {
            if (list == null) {
                NotificationUtil.notifyWarn(project, "Please select at least 2 " +
            ...
            PopupUtil.getChooseInterfacePopup(file, project, null,
                    interfaceToImpl -> new FactoryTemplate(event, list, interfaceToImpl).generateText());
        });
    }
}
